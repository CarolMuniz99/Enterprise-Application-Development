...
public class Veiculo {
	...
	@GeneratedValue(generator="veiculo",strategy=GenerationType.SEQUENCE) //Configurar para usar a sequência (ORACLE)
	private int codigo;
	...
	@Enumerated(EnumType.STRING) //Adiciona no banco a descrição e não a posição
